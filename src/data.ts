export const title = 'Anna-Maria Jürgensen'
export const description =
  'Computational neuroscience of learning and memory, based at Imperial College London and the University of Cambridge.'

export const emails = ['a.jurgensen@imperial.ac.uk', 'amj70@cam.ac.uk']

export const socials = [
  {
    name: 'BlueSky',
    href: 'https://bsky.app/profile/did:plc:pcosszf7nw7ryzcskkgiw2lx',
    icon: 'simple-icons:bluesky',
    color: '#2e8afc',
  },
  {
    name: 'ORCID',
    href: 'https://orcid.org/0000-0002-7871-1887',
...
export const educations = [
  {
    period: '10/2016 - 01/2019',
    degree: 'PhD in Computational Systems Neuroscience',
    institution: 'Computational Systems Neuroscience, University of Cologne',
    details: [
...
export const researchExperiences = [
  ...
  {
    period: '02/2016 - 07/2016',
    position: 'Research Internship',
    details: 'Clinical Psychology (Tania Lincoln), University of Hamburg',
  },
  {
    period: '08/2015 - 12/2015',
    position: 'Research Internship',
    details: 'Cognitive Sciences (Sverker Sikström), Lund University',
  },
  {
    period: '03/2013 - 07/2015',
    position: 'Research Assistant',
    details:
...
export const journalArticles = [
  {
    ...
    details: 'eLife, page 14:RP104262',
  },
  {
    year: 2025,
    authors:
    ...
    details: 'Cell Reports, volume 44, page 115593',
  },
  {
    year: 2024,
    authors:
    ...
    details: 'Frontiers in Physiology, volume 14, page 1326307',
  },
  {
    year: 2024,
    authors:
    ...
    details: 'iScience, volume 27, page 108640',
  },
  {
    year: 2021,
    authors:
    ...
    details: 'Neuromorphic Computing and Engineering, volume 1, page 024008',
  },
  {
    year: 2016,
    authors:
    ...
    details: 'Neural plasticity, volume 2016',
  },
]
...
export const invitedTalks = [
  {
    ...
    location: 'Max-Planck-Institut für Dynamik und Selbstorganisation',
  },
  {
    year: 2022,
    title: 'A spiking model of drosophila larva olfactory learning',
    location: 'Arthropod Neuroscience Network, University of Cologne',
  },
]

export const awardsAndFunding = [
  {
    year: '2025 - 2027',
    title:
  ...
  {
    year: '2025',
    title: 'Postdoctoral Fellowship - Walter Benjamin, DFG (declined)',
  },
  {
    year: '2025',
    title:
  ...
  {
    year: '2022',
    title: 'Cornelia Harte Mentoring PRO, University of Cologne',
  },
  {
    year: '2015',
